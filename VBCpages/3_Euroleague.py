...
if marco == "Estadísticas de un partido":
    ...
    id_game = df_games_Euroleague[(df_games_Euroleague['ID Temporada'] == season) & (df_games_Euroleague['Partido'] == game)].iloc[0]['ID Partido']
    ...
    df_partido = df_games_Euroleague[(df_games_Euroleague['ID Partido'] == id_game)][columns_to_show]
    ...
    df_games_records = df_games_Euroleague.copy()
