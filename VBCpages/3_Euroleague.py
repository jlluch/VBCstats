...
def load_data():
    ...
    df_players_Euroleague = st.session_state.df_players_Euroleague
    df_games_Euroleague = st.session_state.df_games_Euroleague
...
if marco == "Estadísticas de un partido":
    ...
    game_list = df_games_Euroleague[df_games_Euroleague['ID Temporada'] == season]['Partido']
    ...
    id_game = (game_list.iloc[index]).split(" - ")[0]  # Obtener el ID del partido
    ...
    st.dataframe(df_games_Euroleague[(df_games_Euroleague['ID Partido'] == id_game)][columns_to_show], hide_index=True)
