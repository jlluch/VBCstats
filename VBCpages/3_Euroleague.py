...
# P1Rival	P2Rival	Q1Rival	Q2Rival	Q3Rival	Q4Rival	PR1Rival	PR2Rival
    return df_players_Euroleague, df_games_Euroleague

#Cargar los datos
df_players_Euroleague, df_games_Euroleague = load_data()

# Crear una columna con el partido
df_games_Euroleague['Partido'] = df_games_Euroleague.apply(lambda x: f"VBC - {x['Equipo Rival']}"  if x['VBC Local'] else f"{x['Equipo Rival']} - VBC", axis=1)
...
st.title("Estadísticas de la Euroliga")
...
if marco == "Estadísticas de un partido":
    ...
    game_list = df_games_Euroleague[df_games_Euroleague['ID Temporada'] == season][['Fecha','Partido']]
    ...
    st.dataframe(df_games_Euroleague[(df_games_Euroleague['ID Temporada'] == season) & (df_games_Euroleague['Fecha'] == date)][columns_to_show], hide_index=True)
    ...
    players_vbc = df_players_Euroleague[(df_players_Euroleague['ID Temporada'] == season) & (df_players_Euroleague['Fecha'] == date)]
    ...
    if tipo == "Total":
        ...
        max_steals = df_players_Euroleague.groupby('Nombre')['Robos'].sum().sort_values(ascending=False)
        max_blocks = df_players_Euroleague.groupby('Nombre')['Tapones'].sum().sort_values(ascending=False)
        max_val = df_players_Euroleague.groupby('Nombre')['Val'].sum().sort_values(ascending=False)
        #Cambiar nombre de la columna
        ...
        shots = df_players_Euroleague.groupby('Nombre')[['T1a', 'T1i', 'T2a', 'T2i', 'T3a', 'T3i']].sum()
        ...
        filtered_players = df_players_Euroleague.groupby('Nombre')['ID Partido'].count()
        ...
        max_rebounds = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['Rebotes'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        max_assists = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['Asistencias'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        max_steals = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['Robos'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        max_steals['Media'] = round(max_steals['Robos']/max_games,1)
        max_steals = max_steals.sort_values(by='Media',ascending=False).head(lh)
        
        max_blocks = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['Tapones'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        max_blocks['Media'] = round(max_blocks['Tapones']/max_games,1)
        max_blocks = max_blocks.sort_values(by='Media',ascending=False).head(lh)
        
        max_val = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['Val'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        # Mostrar los resultados en una tabla
        max_T1a = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['T1a'].sum())
        ...
        max_T2a = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['T2a'].sum())
        # Renombrar la columna
        ...
        max_T3a = pd.DataFrame(df_players_Euroleague[df_players_Euroleague['Nombre'].isin(filtered_players)].groupby('Nombre')['T3a'].sum())
        # Renombrar la columna
    ...
    jornadas_temporada = df_games_Euroleague[df_games_Euroleague['ID Temporada'] == season]['Jornada'].unique()
    ...
    season_games = df_games_Euroleague[df_games_Euroleague['ID Temporada'] == season]
    ...
    #Seleccionar una temporada, ordenar las temporadas de mayor a menor
    season = st.selectbox("Selecciona una temporada", df_games_Euroleague['ID Temporada'].sort_values(ascending=False).unique(), index=0)
    #Crear un marco para mostrar los acumulados de la temporada
    ...
    #Puntos partido
    max10_points = df_games_Euroleague.sort_values(by='Puntos VBC',ascending=False).head(lh)
    ...
    max10_diff = df_games_Euroleague.sort_values(by='Diferencia',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    max10_p1 = df_games_Euroleague.sort_values(by='P1VBC',ascending=False).head(lh)
    max10_p2 = df_games_Euroleague.sort_values(by='P2VBC',ascending=False).head(lh)
    ...
    max10_q1 = df_games_Euroleague.sort_values(by='Q1VBC',ascending=False).head(lh)
    max10_q2 = df_games_Euroleague.sort_values(by='Q2VBC',ascending=False).head(lh)
    max10_q3 = df_games_Euroleague.sort_values(by='Q3VBC',ascending=False).head(lh)
    max10_q4 = df_games_Euroleague.sort_values(by='Q4VBC',ascending=False).head(lh)
    ...
    # Rebotes
    max10_rebounds = df_games_Euroleague.sort_values(by='Rebotes VBC',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    # Asistencias 
    max10_assists = df_games_Euroleague.sort_values(by='Asistencias VBC',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    # Robos
    max10_steals = df_games_Euroleague.sort_values(by='Robos VBC',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    # Tapones
    max10_blocks = df_games_Euroleague.sort_values(by='Tapones VBC',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    # Valoración
    max10_val = df_games_Euroleague.sort_values(by='Val VBC',ascending=False).head(lh)
    #Seleccionar las columnas a mostrar
    ...
    # Tiros de 1 punto
    max10_t1a = df_games_Euroleague.sort_values(by='T1a VBC',ascending=False).head(lh)
    ...
    # Tiros de 2 puntos
    max10_t2a = df_games_Euroleague.sort_values(by='T2a VBC',ascending=False).head(lh)
    # Multiplicar por 100 para mostrar el porcentaje
    ...
    # Tiros de 3 puntos
    max10_t3a = df_games_Euroleague.sort_values(by='T3a VBC',ascending=False).head(lh)
    # Multiplicar por 100 para mostrar el porcentaje
    ...
    # Tiros de 1 punto
    max10_t1p = df_games_Euroleague.sort_values(by=['T1% VBC','T1a VBC'],ascending=False).head(lh)
    # Multiplicar por 100 para mostrar el porcentaje
    ...
    # Tiros de 2 puntos
    max10_t2p = df_games_Euroleague.sort_values(by=['T2% VBC','T2a VBC'],ascending=False).head(lh)
    # Multiplicar por 100 para mostrar el porcentaje
    ...
    # Tiros de 3 puntos
    max10_t3p = df_games_Euroleague.sort_values(by=['T3% VBC','T3a VBC'],ascending=False).head(lh)
    # Multiplicar por 100 para mostrar el porcentaje
    ...
    season_players = df_players_Euroleague[df_players_Euroleague['ID Temporada'] == season]
    ...
    if resultado_filtro != "Todos":
        ...
        partidos_filtrados = df_games_Euroleague[(df_games_Euroleague['ID Temporada'] == season) & 
                                          (df_games_Euroleague['VBC Victoria'] == victoria_valor)]['ID Partido'].unique()
    ...
    if len(season_players) == 0:
        ...
        for jugador_id in jugadores:
            ...
            nombre_jugador = df_players_Euroleague[df_players_Euroleague['ID Jugador'] == jugador_id]['Nombre'].unique()[0]
            ...
            victorias = len(df_games_Euroleague[df_games_Euroleague['ID Partido'].isin(id_partidos_jugados) & 
                                         (df_games_Euroleague['VBC Victoria'] == 1)])
    ...
    # Filtra los equipos
    # Selecciona los equipos únicos de la columna 'ID Rival' del DataFrame df_games_Euroleague
    # Lee dataframe de equipos de Euroliga primera columna IDs del equipo, segunda columna nombre del equipo
    path = r"Data/"
    df_teams_Euroleague = pd.read_csv(path+'teams_Euroleague.csv')
    nombres_rivales = df_teams_Euroleague['Team'].unique().tolist()
    ...
    ids_rival = ast.literal_eval(df_teams_Euroleague[df_teams_Euroleague['Team'] == rival]['ID'].values[0])

    # Selecciona todos los partidos contra el rival    
    partidos_rival = df_games_Euroleague[df_games_Euroleague['ID Rival'].isin(ids_rival)]
    ...
    entrenadores = df_games_Euroleague.groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
    ...
    entrenadores_local = df_games_Euroleague[df_games_Euroleague['VBC Local'] == 1].groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
        Partidos=('ID Partido', 'count'),
        Victorias=('VBC Victoria', lambda x: (x == 1).sum()),
        Derrotas=('VBC Victoria', lambda x: (x == 0).sum())
    ).reset_index()
    ...
    entrenadores_visitante = df_games_Euroleague[df_games_Euroleague['VBC Local'] == 0].groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
        Partidos=('ID Partido', 'count'),
        Victorias=('VBC Victoria', lambda x: (x == 1).sum()),
        Derrotas=('VBC Victoria', lambda x: (x == 0).sum())
    ).reset_index()
    ...
    total_games = len(df_games_Euroleague)
    total_wins = df_games_Euroleague['VBC Victoria'].sum()
    total_losses = total_games - total_wins
    total_home = df_games_Euroleague['VBC Local'].sum()
    total_away = total_games - total_home
    total_home_wins = df_games_Euroleague[df_games_Euroleague['VBC Local'] == 1]['VBC Victoria'].sum()
    total_away_wins = df_games_Euroleague[df_games_Euroleague['VBC Local'] == 0]['VBC Victoria'].sum()
    total_home_losses = total_home - total_home_wins
    total_away_losses = total_away - total_away_wins
    total_home_wins_percentage = round(total_home_wins * 100 / total_home, 1) if total_home > 0 else 0
    total_away_wins_percentage = round(total_away_wins * 100 / total_away, 1) if total_away > 0 else 0
    ...
    team_stats_vbc = pd.DataFrame(df_games_Euroleague[['Puntos VBC', 'Rebotes VBC', 'Asistencias VBC', 'Robos VBC', 'Tapones VBC', 'Val VBC']].sum(), columns=['Acumulados'])
    team_stats_vbc['Media'] = round(team_stats_vbc['Acumulados'] / total_games, 1)
    team_stats_rival = pd.DataFrame(df_games_Euroleague[['Puntos Rival', 'Rebotes Rival', 'Asistencias Rival', 'Robos Rival', 'Tapones Rival', 'Val Rival']].sum(), columns=['Acumulados'])
    team_stats_rival['Media'] = round(team_stats_rival['Acumulados'] / total_games, 1)
    # Datos de tiros VBC
    team_shots_vbc = pd.DataFrame(df_games_Euroleague[['T1a VBC', 'T1i VBC', 'T2a VBC', 'T2i VBC', 'T3a VBC', 'T3i VBC']].sum(), columns=['Acumulados'])
    ...
    # Datos de tiros Rival
    team_shots_rival = pd.DataFrame(df_games_Euroleague[['T1a Rival', 'T1i Rival', 'T2a Rival', 'T2i Rival', 'T3a Rival', 'T3i Rival']].sum(), columns=['Acumulados'])
