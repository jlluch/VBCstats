...
@st.cache_data 
def load_data():
    df_players_Eurocup = st.session_state.df_players_Eurocup
    df_games_Eurocup = st.session_state.df_games_Eurocup
    return df_players_Eurocup, df_games_Eurocup

#Cargar los datos
df_players_Eurocup, df_games_Eurocup = load_data()
...
if marco == "Estadísticas de un partido":
    ...
    game_list = df_games_Eurocup[df_games_Eurocup['ID Temporada'] == season]['Partido']
    ...
    st.dataframe(df_games_Eurocup[(df_games_Eurocup['ID Partido'] == id_game)], hide_index=True)
    ...
    st.dataframe(df_games_Eurocup[(df_games_Eurocup['ID Partido'] == id_game)][columns_to_show], hide_index=True)
    ...
    players_vbc = df_players_Eurocup[(df_players_Eurocup['ID Partido'] == id_game)]
    ...
    if tipo == "Total":
        ...
        max_games = df_players_Eurocup.groupby('Nombre')['ID Partido'].count().sort_values(ascending=False)
        #Cambiar nombre de la columna
        max_games = max_games.rename("Partidos")
        max_points = df_players_Eurocup.groupby('Nombre')['Puntos'].sum().sort_values(ascending=False)
        max_rebounds = df_players_Eurocup.groupby('Nombre')['Rebotes'].sum().sort_values(ascending=False)
        max_assists = df_players_Eurocup.groupby('Nombre')['Asistencias'].sum().sort_values(ascending=False)
        max_steals = df_players_Eurocup.groupby('Nombre')['Robos'].sum().sort_values(ascending=False)
        max_blocks = df_players_Eurocup.groupby('Nombre')['Tapones'].sum().sort_values(ascending=False)
        max_val = df_players_Eurocup.groupby('Nombre')['Val'].sum().sort_values(ascending=False)
        #Cambiar nombre de la columna
        ...
        shots = df_players_Eurocup.groupby('Nombre')[['T1a', 'T1i', 'T2a', 'T2i', 'T3a', 'T3i']].sum()
        ...
        filtered_players = df_players_Eurocup.groupby('Nombre')['ID Partido'].count()
        filtered_players = filtered_players[filtered_players >= 30].index

        max_games = df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['ID Partido'].count()
        max_points = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Puntos'].sum())
        ...
        max_rebounds = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Rebotes'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        max_assists = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Asistencias'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        max_steals = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Robos'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        max_steals['Media'] = round(max_steals['Robos']/max_games,1)
        max_steals = max_steals.sort_values(by='Media',ascending=False).head(lh)
        
        max_blocks = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Tapones'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        max_blocks['Media'] = round(max_blocks['Tapones']/max_games,1)
        max_blocks = max_blocks.sort_values(by='Media',ascending=False).head(lh)
        
        max_val = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Val'].sum())
        # Calcular la media por partido, teniendo en cuenta los partidos que ha jugado cada jugador
        ...
        # Mostrar los resultados en una tabla
        max_T1a = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['T1a'].sum())
        ...
        max_T2a = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['T2a'].sum())
        # Renombrar la columna
        ...
        max_T3a = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['T3a'].sum())
        # Renombrar la columna
    ...
    jornadas_temporada = df_games_Eurocup[df_games_Eurocup['ID Temporada'] == season]['Jornada'].unique()
    ...
    season_games = df_games_Eurocup[df_games_Eurocup['ID Temporada'] == season]
    ...
    max10_p1 = df_games_Eurocup.sort_values(by='P1VBC',ascending=False).head(lh)
    max10_p2 = df_games_Eurocup.sort_values(by='P2VBC',ascending=False).head(lh)
    ...
    max10_q1 = df_games_Eurocup.sort_values(by='Q1VBC',ascending=False).head(lh)
    max10_q2 = df_games_Eurocup.sort_values(by='Q2VBC',ascending=False).head(lh)
    max10_q3 = df_games_Eurocup.sort_values(by='Q3VBC',ascending=False).head(lh)
    max10_q4 = df_games_Eurocup.sort_values(by='Q4VBC',ascending=False).head(lh)
    ...
    season_players = df_players_Eurocup[df_players_Eurocup['ID Temporada'] == season]
    ...
    if resultado_filtro != "Todos":
        ...
        partidos_filtrados = df_games_Eurocup[(df_games_Eurocup['ID Temporada'] == season) & 
                                          (df_games_Eurocup['VBC Victoria'] == victoria_valor)]['ID Partido'].unique()
    ...
    if len(season_players) == 0:
        ...
        for jugador_id in jugadores:
            ...
            nombre_jugador = df_players_Eurocup[df_players_Eurocup['ID Jugador'] == jugador_id]['Nombre'].unique()[0]
            ...
            victorias = len(df_games_Eurocup[df_games_Eurocup['ID Partido'].isin(id_partidos_jugados) & 
                                         (df_games_Eurocup['VBC Victoria'] == 1)])
    ...
    ids_rival = ast.literal_eval(df_teams_Eurocup[df_teams_Eurocup['Team'] == rival]['ID'].values[0])
    ...
    entrenadores = df_games_Eurocup.groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
    ...
    entrenadores_local = df_games_Eurocup[df_games_Eurocup['VBC Local'] == 1].groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
        Partidos=('ID Partido', 'count'),
        Victorias=('VBC Victoria', lambda x: (x == 1).sum()),
        Derrotas=('VBC Victoria', lambda x: (x == 0).sum())
    ).reset_index()
    ...
    entrenadores_visitante = df_games_Eurocup[df_games_Eurocup['VBC Local'] == 0].groupby(['ID Entrenador VBC', 'Entrenador VBC']).agg(
        Partidos=('ID Partido', 'count'),
        Victorias=('VBC Victoria', lambda x: (x == 1).sum()),
        Derrotas=('VBC Victoria', lambda x: (x == 0).sum())
    ).reset_index()
    ...
    total_games = len(df_games_Eurocup)
    total_wins = df_games_Eurocup['VBC Victoria'].sum()
    total_losses = total_games - total_wins
    total_home = df_games_Eurocup['VBC Local'].sum()
    total_away = total_games - total_home
    total_home_wins = df_games_Eurocup[df_games_Eurocup['VBC Local'] == 1]['VBC Victoria'].sum()
    total_away_wins = df_games_Eurocup[df_games_Eurocup['VBC Local'] == 0]['VBC Victoria'].sum()
    total_home_losses = total_home - total_home_wins
    total_away_losses = total_away - total_away_wins
    total_home_wins_percentage = round(total_home_wins * 100 / total_home, 1) if total_home > 0 else 0
    total_away_wins_percentage = round(total_away_wins * 100 / total_away, 1) if total_away > 0 else 0
    ...
    team_stats_vbc = pd.DataFrame(df_games_Eurocup[['Puntos VBC', 'Rebotes VBC', 'Asistencias VBC', 'Robos VBC', 'Tapones VBC', 'Val VBC']].sum(), columns=['Acumulados'])
    team_stats_vbc['Media'] = round(team_stats_vbc['Acumulados'] / total_games, 1)
    team_stats_rival = pd.DataFrame(df_games_Eurocup[['Puntos Rival', 'Rebotes Rival', 'Asistencias Rival', 'Robos Rival', 'Tapones Rival', 'Val Rival']].sum(), columns=['Acumulados'])
    team_stats_rival['Media'] = round(team_stats_rival['Acumulados'] / total_games, 1)
    # Datos de tiros VBC
    team_shots_vbc = pd.DataFrame(df_games_Eurocup[['T1a VBC', 'T1i VBC', 'T2a VBC', 'T2i VBC', 'T3a VBC', 'T3i VBC']].sum(), columns=['Acumulados'])
    ...
    # Datos de tiros Rival
    team_shots_rival = pd.DataFrame(df_games_Eurocup[['T1a Rival', 'T1i Rival', 'T2a Rival', 'T2i Rival', 'T3a Rival', 'T3i Rival']].sum(), columns=['Acumulados'])
