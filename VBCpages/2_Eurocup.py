...
df_games_Eurocup['Partido'] = df_games_Eurocup.apply(lambda x: f"VBC - {x['Equipo Rival']}"  if x['VBC Local'] else f"{x['Equipo Rival']} - VBC", axis=1)
...
if marco == "Estadísticas de un partido":
    ...
    game_list = df_games_Eurocup[df_games_Eurocup['ID Temporada'] == season][['Fecha','Partido']]
    ...
    players_vbc = df_players_Eurocup[(df_players_Eurocup['ID Temporada'] == season) & (df_players_Eurocup['Fecha'] == date)]
