...
if marco == "Estadísticas de un partido":
    ...
    if tipo == "Total":
        ...
        current_season = df_players_Eurocup['ID Temporada'].max()
        # Selecciona el ID de los jugadores de la temporada actual
        current_players = df_players_Eurocup[df_players_Eurocup['ID Temporada'] == current_season]['ID Jugador'].unique()
        # Filtra los jugadores de la temporada actual
        current_players_df = df_players_Eurocup[df_players_Eurocup['ID Jugador'].isin(current_players)]
    ...
    equipos = df_games_Eurocup[df_games_Eurocup['ID Temporada'] == season]['Equipo Rival'].unique()  
    # Selecciona el rival
    ...
    previous_season_players = df_players_Eurocup[df_players_Eurocup['ID Temporada'] == previous_season]
    ...
    for i, player_id in enumerate(common_player_ids):
        ...
        player_name = df_players_Eurocup[df_players_Eurocup['ID Jugador'] == player_id]['Nombre'].unique()[0]
