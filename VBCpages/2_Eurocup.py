...
if marco == "Estadísticas de un partido":
    ...
    id_game = df_games_Eurocup[(df_games_Eurocup['ID Temporada'] == season) & (df_games_Eurocup['Partido'] == game)].iloc[0]['ID Partido']
    ...
    df_partido = df_games_Eurocup[(df_games_Eurocup['ID Partido'] == id_game)][columns_to_show]
    ...
    if tipo == "Total":
        ...
        max_minutes = df_players_Eurocup.groupby('Nombre')['Minutos'].sum().sort_values(ascending=False)
        ...
        max_minutes = pd.DataFrame(df_players_Eurocup[df_players_Eurocup['Nombre'].isin(filtered_players)].groupby('Nombre')['Minutos'].sum())
    ...
    df_games_records = df_games_Eurocup.copy()
